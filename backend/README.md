...
## Project Structure
    ...
    ├── testapiautocatalog_125150  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_125150`
...
2. Clone this repo and `cd testapiautocatalog_125150`
